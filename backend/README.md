...
## Project Structure
    ...
    ├── withfrank_wordpress_30650  # Django project configurations
...
1. Clone this repo and `cd withfrank_wordpress_30650`
...
2. Clone this repo and `cd withfrank_wordpress_30650`
